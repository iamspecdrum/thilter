...
class SmallKnob1Light : public juce::LookAndFeel_V4
{
public:
                          ...
                          float rotaryEndAngle, juce::Slider& slider) override
    {
        ...
        juce::Image filmStrip = juce::ImageCache::getFromMemory(BinaryData::smallknob1imagestrip_light_png, BinaryData::smallknob1imagestrip_light_pngSize);
