...
class SmallKnob2Light : public juce::LookAndFeel_V4
{
public:
                          ...
                          float rotaryEndAngle, juce::Slider& slider) override
    {
        ...
        juce::Image filmStrip = juce::ImageCache::getFromMemory(BinaryData::smallknob2imagestrip_light_png, BinaryData::smallknob2imagestrip_light_pngSize);
